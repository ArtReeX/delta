...
//-- объявление типа идентификаторов для многосодержащего типа Arbitration --//
typedef std::map< unsigned int, SArbitration > MArbitration;

//-- объявление типа идентификаторов для многосодержащего типа Collection --//
