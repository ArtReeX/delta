...
void __fastcall TEditFormLines::FormShow(TObject *Sender)
{
	...
	//-- установка начального состо€ни€ выбора всех источников, валют и базовой валюты --//
	...
	//-- очистка пол€ с именем --//
	NameEdit->Clear();

	//-- изначальное заполнение пол€ с именем --//
	NameEdit->Text = map_iterator->second.name;




	//-- очистка пол€ с источниками --//
	SourcesCheckList->Clear();

	//-- изначальное заполнение пол€ активными источниками --//
	...
	//-- заполнение пол€ неактивными источниками --//
	...
	//-- очистка пол€ с валютами --//
	CurrencysCheckList->Clear();

	//-- изначальное заполнение пол€ активными валютами --//
	...
	//-- заполнение пол€ неактивными валютами --//
	...
	//-- очистка пол€ с базовыми валютами --//
	BasesCheckList->Clear();

	//-- изначальное заполнение пол€ нективными базовыми валютами --//
...
//-- ‘”Ќ ÷»я ќЅ–јЅќ“ » ѕќ Ќј∆ј“»ё Ќј  Ќќѕ ” "Save" --//
void __fastcall TEditFormLines::SaveButton_OneClick(TObject *Sender)
{
	...
	//-- ‘ќ–ћ»–ќ¬јЌ»≈ —“–ќ » ƒќЅј¬Ћ≈Ќ»я — —“јЌƒј–“Ќџћ» ѕј–јћ≈“–јћ» --//
	...
	//-- отправка запроса добавлени€ на сервер --//
	MainForm->engine->Send("editLine", param, "CheckEditLine");

	//-- закрытие формы добавлени€ --//
	Close();
}
...
//-- ‘”Ќ ÷»я ќЅЌќ¬Ћ≈Ќ»я Ѕј«ќ¬џ’ ¬јЋё“ ƒЋя ¬ќ«ћќ∆Ќќ—“» »’ ¬џЅќ–ј --//
